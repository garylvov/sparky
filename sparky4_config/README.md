...
#### 1.1.1. Run the base driver:
    ...
    roslaunch sparky4_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch sparky4_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch sparky4_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch sparky4_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch sparky4_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
