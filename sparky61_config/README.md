...
#### 1.1.1. Run the base driver:
    ...
    roslaunch sparky61_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch sparky61_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch sparky61_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch sparky61_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch sparky61_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
